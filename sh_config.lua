...
TCB_Settings.TitleOne		= "Avenement de la Force"
TCB_Settings.TitleTwo		= "108 Jobs / 6 Factions"

TCB_Settings.PrimaryColor	= Color( 166, 166, 166, 255 )
TCB_Settings.SecondaryColor	= Color( 0, 229, 222, 255 )
